...
class ProfileFriendsAdapted(var context: Context,var list: ArrayList<FriendsModel>):RecyclerView.Adapter<myfriendsvh>(){
    ...
    override fun onBindViewHolder(holder: myfriendsvh, position: Int) {
        holder.profile_img.setImageBitmap(resizeDrawable(context.applicationContext,list.get(position).f_pic,50,50))
    }
}
